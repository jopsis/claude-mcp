...
![Claude Desktop 查询 SQLite 数据库结果](https://static.claudemcp.com/images/claude-sqlite-result.png)
...
![内置的 MCP 服务器列表](https://static.claudemcp.com/images/claude-builtin-servers.png)
